...
map[1] = "X   X              X";
map[2] = "X XXXXXX XXXXXXXXX X";
map[3] = "X X      X         X";
map[4] = "X      XXX  XXXXXXXX";
map[5] = "XXX XXXXXXX        X";
map[6] = "X X       XXXXXXXX X";
map[7] = "X XXXXXX  X      X X";
map[8] = "X         X XXXXXX X";
map[9] = "XXXXXXXXX X X      X";
map[10] = "X      X  X    X   X";
map[11] = "X   X     X XXXXXX X";
map[12] = "X XXXXXXXXX        X";
map[13] = "X X    X      XXXXXX";
map[14] = "X      X   X       X";
map[15] = "XXX XXXX XXXXXXXX  X";
map[16] = "X X                X";
map[17] = "X XXXXXX XXXXXXXXXXX";
map[18] = "X                  X";
